...
var createPins = function () {
  ...
  for (var i = 0; i < ads.length; i++) {
    fragmentPin.appendChild(fillPinInfo(ads[i]));
  }
...
/* var createCard = function () {
  ...
  fragmentCard.appendChild(fillCardInfo(ads[0]));
...
// createCard(); // создание и отрисовка карточки
}
